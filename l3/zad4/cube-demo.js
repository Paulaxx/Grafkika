...
var redraw = function () {
    ...
    gl.uniformMatrix4fv(rotationLocation, false, rectangle.rotationMatrix);
    gl.uniform3fv(moveLocation, rectangle.moveVector);
    gl.uniformMatrix4fv(projectionLocation, false, projectionMatrix);
    gl.uniform1f(ambientStrengthLocation, 1)
    ...
    gl.uniform1f(pikselLocation, rectangle.piksel)
    gl.uniform3f(colorLocation, 1, 1, 1)

    gl.enableVertexAttribArray(aPositionLocation);
    gl.bindBuffer(gl.ARRAY_BUFFER, rectangle.glInfo.positionBuffer);
    gl.vertexAttribPointer(aPositionLocation, 3, gl.FLOAT, false, 0, 0);

    gl.disableVertexAttribArray(aNormalLocation);
    gl.drawArrays(gl.TRIANGLE_FAN, 0, rectangle.points.length / 3);
    ...
    plots.forEach(plot_item => {
        ...
        gl.stencilFunc(
            gl.EQUAL,
            plot_item.piksel_buffer, //if(0 EQUAAL stencil_buffer)
            0xFF,
        );
        gl.stencilOp(
            gl.KEEP,
