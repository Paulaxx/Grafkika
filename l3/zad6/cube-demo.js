...
var fragmentShaderSource = "" +
    ...
    "    gl_FragColor = mix(vec4(result, 0.9), vec4(u_fogColor, 1.0), fogAmount);\n" +
    "}\n";
...
var redraw = function () {
    ...
    plots.forEach(plot_item => {
        ...
        gl.colorMask(plot_item.piksel == 1 ? 0 : 1, plot_item.piksel, plot_item.piksel, 1);
        ...
        gl.uniform3f(colorLocation, 1, 0.5, 0.9)
...
function onKeyDown(e) {
    ...
    switch (code) {
        case 38: // up
        case 73: // I
            plots[0].rotation(alpha, 0);
            plots[1].rotation(alpha, 0);
            break;
        case 40: // down
        case 75: // K
            plots[0].rotation(-alpha, 0);
        ...
        case 37: // left
        case 74:// J
            plots[0].rotation(0, -alpha);
            plots[1].rotation(0, -alpha);
            break;
        case 39:// right
        case 76: // L
            plots[0].rotation(0, alpha);
            ...
            break;
        case 70: // F
            plots[0].moveVector[2]++;
            plots[1].moveVector[2]++;
            break;
        case 66: // B
        case 86: // V
            plots[0].moveVector[2]--;
