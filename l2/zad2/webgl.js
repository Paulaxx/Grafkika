...
export class WebGL {
    ...
    draw(turtles, primitiveType) {
        ...
        turtles.forEach(element => {
            ...
            this.gl.uniform4f(this.locations.uniforms.color, ...element.turtle.color);
            this.gl.uniform1f(this.locations.uniforms.depth, element.turtle.z);
